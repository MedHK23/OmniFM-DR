...
from data.mm_data.report_mlm_dataset import ReportMLMDataset
...
@dataclass
class ReportMLMConfig(OFAConfig):
...
@register_task("report_mlm", dataclass=ReportMLMConfig)
class ReportMLMTask(OFATask):
    def __init__(self, cfg: ReportMLMConfig, src_dict, tgt_dict):
    ...
    def load_dataset(self, split, epoch=1, combine=False, **kwargs):
        ...
        self.datasets[split] = ReportMLMDataset(
            split,
            dataset,
            self.bpe,
            self.src_dict,
