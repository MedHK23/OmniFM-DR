...
from data.mm_data.report_vqa_dataset import ReportVqaDataset
...
@dataclass
class ReportVqaConfig(OFAConfig):
...
@register_task("report_vqa", dataclass=ReportVqaConfig)
class ReportVqaTask(OFATask):
    def __init__(self, cfg: ReportVqaConfig, src_dict, tgt_dict):
    ...
    def load_dataset(self, split, epoch=1, combine=False, **kwargs):
        ...
        self.datasets[split] = ReportVqaDataset(
            split,
            dataset,
            self.bpe,
            self.src_dict,
