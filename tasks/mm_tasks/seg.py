...
from data.mm_data.seg_dataset import SegDataset
...
@register_task("seg", dataclass=SegConfig)
class SegTask(OFATask):
    def __init__(self, cfg: SegConfig, src_dict, tgt_dict):
    ...
    def load_dataset(self, split, epoch=1, combine=False, **kwargs):
        ...
        self.datasets[split] = SegDataset(
            split,
            dataset,
            self.bpe,
            self.src_dict,
